...
Test data showed that Fast-GeP that equipped with the new algorithm achieved significant improvements in allele calling efficiency compared to conventional gene-by-gene approach. It renders a fast and easy way to infer high-resolution genealogical relationships between bacterial isolates using WGS data.
